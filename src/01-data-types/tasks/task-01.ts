...
const calculatedFinalScore: number = (assignmentScore * 0.2) + (midtermScore * 0.3) + (finalScore * 0.4) + (attendanceScore * 0.1);

console.log("==Data Terserah==");
console.log({studentName, studentID, assignmentScore, midtermScore, finalScore, attendanceScore, extracurricularParticipation});